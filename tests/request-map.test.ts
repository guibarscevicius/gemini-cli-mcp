...
describe("request-map", () => {
  ...
  it("unregisterByJobId removes the mapped request entry", () => {
    registerRequest("req-1", "job-a");
    registerRequest("req-2", "job-b");
    unregisterByJobId("job-a");
    expect(getJobByRequestId("req-1")).toBeUndefined();
    expect(getJobByRequestId("req-2")).toBe("job-b");
  });
  ...
  it("register -> unregisterByJobId removes forward and reverse entries", () => {
    registerRequest("req-1", "job-a");
    unregisterByJobId("job-a");
  ...
  it("unregisterRequest also cleans reverse map", () => {
    registerRequest("req-1", "job-a");
    unregisterRequest("req-1");
